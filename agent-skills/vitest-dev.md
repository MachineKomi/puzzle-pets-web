...
## Attribution
- Source skill: `vitest-dev`
- Original repository: https://github.com/BjornMelin/dev-skills
- Original path: `skills/vitest-dev/SKILL.md`
- Imported from commit: `735ce969d05b84983d7dc3fbf8adc9cd7c53c8d2`

## License
- Local license file: `agent-skills/skill-licenses/vitest-dev-license.txt`
- License source (upstream): `skills/vitest-dev/LICENSE` in https://github.com/BjornMelin/dev-skills
