...
## Attribution
- Source skill: `tailwind-4-docs`
- Original repository: https://github.com/Lombiq/Tailwind-Agent-Skills
- Original path: `skills/tailwind-4-docs/SKILL.md`
- Imported from branch/commit: `dev@8386af027565df77867fcebc3765917f29f7ece6`

## License
- Local license file: `agent-skills/skill-licenses/tailwind-4-docs-license.txt`
- License source (upstream): `License.md` in https://github.com/Lombiq/Tailwind-Agent-Skills
