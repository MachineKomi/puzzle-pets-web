...
## Attribution
- Source skill: `puzzle-design`
- Original repository: https://github.com/omer-metin/skills-for-antigravity
- Original path: `skills/puzzle-design/SKILL.md`
- Imported from commit: `e8dcf4e8737921a10088bd5c9eb65e81f74c051f`

## License
- Local license file: `agent-skills/skill-licenses/puzzle-design-license.txt`
- License source (upstream): `LICENSE` in https://github.com/omer-metin/skills-for-antigravity
